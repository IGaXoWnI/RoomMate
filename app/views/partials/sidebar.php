<nav id="sidebar" class="lg:w-64 w-max">
        <div id="sidebar-collapse-menu"
          class="bg-[#213555] h-screen fixed top-0 left-0 overflow-auto z-[99] lg:w-64 max-lg:w-0 max-lg:invisible transition-all duration-500">
          <div class="p-6">
            <div class="flex justify-center items-center mb-8">
              <div class="p-3">
                <span class="text-white text-lg font-medium mt-2 block text-center">VeilleHub</span>
              </div>
            </div>
            <div class="py-4">
              <ul class="space-y-2">
                <li>
                  <a href="/dashboard" 
                    class="flex items-center gap-3 px-4 py-3 text-white rounded-lg hover:bg-white/10 transition-all group relative">
                ...
                <li>
                  <a href="/dashboard/sujet"
                    ...
                    <span class="font-medium">Gestion des Sujets</span>
                  </a>
                </li>
